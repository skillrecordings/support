...
if (offenders.length > 0) {
  const message = [
    ...
    '',
    '═══════════════════════════════════════════════════════════════════',
    'IMPORT CONVENTIONS FOR THIS REPO:',
    '═══════════════════════════════════════════════════════════════════',
    '❌ NO barrel imports (index.ts re-exports)',
    '❌ NO relative imports across packages (e.g., ../../other-package)',
    '✅ USE package imports: @skillrecordings/core/front/markdown',
    '✅ Relative imports OK within same package for non-exported internals',
    '✅ All subpath exports must be in package.json "exports" field',
    '═══════════════════════════════════════════════════════════════════',
    '',
    'Agent instructions:',
