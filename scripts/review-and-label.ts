...
const MANUAL_LABELS: Record<string, {
  ...
  // === ACCESS ISSUES ===
  'fbdce81a-808f-[PHONE]-917b8f367320': { category: 'support_access', notes: 'Cant access after login' },
  ...
  'fc87b6bd-[PHONE]-8996-b61e48efaba4': { category: 'support_technical', notes: 'Missing zoom link for workshop' },
  ...
  '516e2785-[PHONE]-bacd-d1f39289e586': { category: 'fan_mail', notes: 'Binged course, loved it' },
  ...
  '[PHONE]-e22e-42d3-9a19-023ac122ff15': { category: 'spam', notes: 'JellyOtter YouTube invite' },
  ...
  '99a13dd1-43fe-[PHONE]-feadd99cc4af': { category: 'fan_mail', notes: 'Survey response - route to instructor' },
  ...
  '736cd845-472a-[PHONE]-2f04cccd7e3c': { category: 'instructor_strategy', notes: 'Internal discussion about content' },
  ...
  '[PHONE]-4c7f-acb7-25d2e45f2ae3': { category: 'support_technical', notes: 'AI confusion question' },
