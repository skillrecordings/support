...
- d8ebbeb: Add CLI improvements: `skill doctor` health check, `skill list` discovery, Linear bulk filters, Inngest patterns
...
- 5a7f248: feat(cli): Add `skill keys` command + deprecate `config init`
