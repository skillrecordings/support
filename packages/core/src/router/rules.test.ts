...
describe('matchRules', () => {
  ...
  describe('keyword rules', () => {
    ...
    it('should be case insensitive', () => {
      ...
      const result = matchRules('URGENT: need help', '[EMAIL]', rules)
  ...
  describe('priority ordering', () => {
    it('should respect priority (lower number = higher priority)', () => {
      ...
      const result = matchRules('I need help', '[EMAIL]', rules)
    ...
    it('should process rules in priority order even if array is unsorted', () => {
      ...
      const result = matchRules('test message', '[EMAIL]', rules)
  ...
  describe('edge cases', () => {
    it('should return null when no rules match', () => {
      ...
      const result = matchRules('bar baz', '[EMAIL]', rules)
      expect(result).toBeNull()
    })

    it('should return null for empty rules array', () => {
      const result = matchRules('any message', '[EMAIL]', [])
      expect(result).toBeNull()
    })
