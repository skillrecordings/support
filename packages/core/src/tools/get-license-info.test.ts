  ...
  describe('successful license lookups', () => {
    it('returns team license with claimed seats', async () => {
      const license: LicenseInfo = {
        ...
        claimedBy: [
          ...
          { email: 'bob@acme.com', claimedAt: '2025-01-16T11:00:00Z' },
        ],
      }
      ...
      if (result.success) {
        ...
        expect(result.data.summary).toContain('alice@acme.com')
      }
    })
    ...
    it('returns enterprise license with admin', async () => {
      ...
      if (result.success) {
        ...
        expect(result.data.summary).toContain('admin@bigcorp.com')
      }
    })
