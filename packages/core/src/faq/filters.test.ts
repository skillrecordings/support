...
describe('isNoiseSenderDomain', () => {
  it('filters CastingWords', () => {
    expect(isNoiseSenderDomain('support@castingwords.com')).toBe(true)
  })

  it('filters Google domains', () => {
    expect(isNoiseSenderDomain('noreply@google.com')).toBe(true)
    expect(isNoiseSenderDomain('workspace@google.co.uk')).toBe(true)
  })

  it('filters cloud service domains', () => {
    expect(isNoiseSenderDomain('billing@mux.com')).toBe(true)
    expect(isNoiseSenderDomain('usage@algolia.com')).toBe(true)
    expect(isNoiseSenderDomain('reports@cloudinary.com')).toBe(true)
  })

  it('allows customer domains', () => {
    expect(isNoiseSenderDomain('user@gmail.com')).toBe(false)
    expect(isNoiseSenderDomain('customer@company.com')).toBe(false)
  })
...
describe('isLessonComment', () => {
  it('detects egghead lesson comments', () => {
    const comment = `Wayne waynedevelops@gmail.com writes:
...
describe('shouldFilter', () => {
  it('filters by sender domain first', () => {
    const result = shouldFilter('Any message', 'support@castingwords.com')
