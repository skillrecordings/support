...
describe('redactPII', () => {
  ...
  it('redacts multiple emails', () => {
    const text = 'Send to alice@test.org and bob@example.com'
    const result = redactPII(text)
  ...
  it('redacts credit card numbers', () => {
    expect(redactPII('Card: 4532-1234-5678-9010')).toBe('Card: [CARD]')
    expect(redactPII('Number 4532 1234 5678 9010')).toBe('Number [CARD]')
  ...
  it('handles text with multiple PII types', () => {
    const text =
      'Contact John Doe at john.doe@example.com or 555-123-4567, card 4532-1234-5678-9010'
