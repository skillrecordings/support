    ...
    "messages": [
      {
        ...
        "author": "matt@totaltypescript.com"
      }
    ]
  },
  "expected": {
    ...
    "messages": [
      {
        ...
        "timestamp": 1700000000,
        "author": { "type": "customer", "email": "customer@example.com" }
      },
      {
        "direction": "out",
        "body": "Let me check your account. What email did you purchase with?",
        "timestamp": 1700000100,
        "author": { "type": "teammate", "email": "haze@egghead.io", "teammateId": "tea_haze" }
      },
      {
        "direction": "in",
        "body": "I think it was mywork@company.com",
        "timestamp": 1700000200,
        "author": { "type": "customer", "email": "customer@example.com" }
      }
    ]
...
5. Agent adds comment: "Customer has purchases under other@email.com - 2 licenses for Total TypeScript Pro"
