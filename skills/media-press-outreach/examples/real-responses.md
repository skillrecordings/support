...
```text
Thanks! I've listened to it already and I thought it was great. Thanks!
```
...
Having led ML and data science teams at Cloudera <https://www.cloudera.com/>,
Remix <https://www.remix.com/>, Clover Health
<https://www.cloverhealth.com/en/>, and KeepTruckin
<https://gomotive.com/get/fleet-management/?qgad=[PHONE]&qgterm=keeptruckin&utm_source=google&utm_medium=paid-search&utm_campaign=SEG_BRD_US_FLEET-MANAGEMENT&_bg=[PHONE]&utm_content=[PHONE]&utm_term=keeptruckin&mt=e&dev=c&dm=&nw=g&cmp=[PHONE]&gad_source=1&gclid=CjwKCAiAq4KuBhA6EiwArMAw1Bi_V2oeUICQumAgyl8F1CsiwzL5ZvR4cOc6pDWqclbHtKUGfuY-SxoCRmkQAvD_BwE>,
Sandy consistently met the same roadblock wherever he worked in the
industry and made what felt like an obvious jump to dev – he knew he had to
build the tool the data industry was looking for.

Sandy decided to join the Dagster Labs team with the mission of addressing
those pain points for the data community across MLOps, data science, IOT,
analytics, and more. With him, he brought his education focused approach
engineering and leadership, never writing a line of code without first
knowing how he would train the end user.

Examples of topics that Sandy can provide value on include:

   - *Education-First Dev: Considering How to Train the End User from Day 1*
   - *Why He Pivoted From Data Science & ML to Building Dev Tools*
   - *Data as Code: Recentering the Data in Orchestration w/ Software
   Defined Assets*
   - *How the Domain of Data Orchestration is Evolving in the Context of AI
   and ML*
   - *The State & Future of Data Dev Tools*


Would you be interested in having Sandy on as a guest? I’d love to
...
[image: instagram] <https://www.instagram.com/kitcaster/>
Podcast hosts make great podcast guests. We’re here for you. ✌️
<https://kitcaster.com/podcast-hosts/>
```
...
on this podcast, and (b) who the right contact is for a media buyer to
learn more about rates, etc.?
...
*Ronald Liu*
*Magellan AI * <https://www.magellan.ai/>| [EMAIL]
If you'd like me to stop sending you emails, please click here
<https://burningbarnlabs.orpluto.com/api/mailings/unsubscribe/PMRGSZBCHI2TQMZXGE3CYITPOJTSEORCHBTDEMRZMRRTCLJQGRRGCLJRGFSTMLJZGQYGCLJQGJRTSYJWHA3WGMZTMIRCYITWMVZHG2LPNYRDUIRUEIWCE43JM4RDUISLJM3HOZBVNNUGC4KCIZHDQNLJIJXFSSJYMNEHGNCWK5VUQWTFOFJDO33QGVDHCNRTGU2D2IT5>
```
...
The interview would be 45-60 minutes, conducted remotely at your convenience. We keep our format conversational and engineering-focused, which our listeners particularly value.

Would you be interested in joining us for an episode? You can book a time that works for you here: https://cal.com/iliashadad/yalla-let-s-podcast
...
My name is Radmila and I work for Manning Publications in the marketing
department. I was made aware of your podcast and wonder if you might be
interested in having some of our authors as guests?



Namely, Jort Rodenburg, author of our book Code like a Pro in C#
<https://www.manning.com/books/code-like-a-pro-in-c-sharp?query=Code%20like%20a%20Pro%20in%20C#>
.



We would also be happy to offer a few free eBook copies and a permanent
discount for your podcast (good for all our products in all formats).
...
```text
Thanks, but I don't take guest recommendations.
```
...
You’ve released some excellent videos lately on AI coding agents, what they
actually are, how they work under the hood, and why understanding context
windows and workflows really matters. I think that would make a perfect
topic for a PodRocket episode.

Let me know if you're interested or have any questions, happy to send along
more information!
...
I represent Hello Retriever and I'd love to showcase you and totaltypescript.com in an article we are working on. In this article we discuss common data security mistakes employees make and to add maximum value, we are seeking input from experts like you who can provide insights on the topic from various diverse perspectives.

If you are willing to participate, I'll send you a question that relates to your expertise or experience. You can then provide a short response. It only needs to be 100-200 words. We will add your input to the article (we might need to edit for length), along with your name and website and a link back to totaltypescript.com. All we then ask is that you include a link to the article somewhere on totaltypescript.com, maybe on your resources page or similar so that we both benefit from the collaboration.

You can check out the article as it stands so far here: https://helloretriever.com/blog/common-data-security-mistakes-employees-make. As you can see, we have already had input from a few contributors, and I would love to include something from you to add further value to the piece.

Let me know if you'd like to participate. It would be great to feature you in the article.

Kind regards,
Lottie 
ps no need to worry about any follow ups but if you do send an 'unsubscribe' I'll take extra steps to make sure I never accidentally email again.
```
...
to invite you to speak at with regarding a topic you are passionate about at the
moment, I have hosted other interesting names in the industry before, let me
...
I'm Dan, a senior writer.



In my efforts to stay ahead in the content world, I've come across some interesting topics that I think your audience would love new insights on.



How about a guest post, fully optimized for Google's latest guidelines and SEO metrics, providing quality insights on these topics?



Would you be open to exploring them with us?
