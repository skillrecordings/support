...
I signed up for the MCP fundamentals workshop scheduled on June 17th back
in May and I can't seem to find the calendar invite to the event. Is there
any way I can get another calendar invite for that sent to this email? I've
...
 
Hello! Please read this all ASAP!
...
4. We use discord for text chat during the event. This allows us to keep a history of our chat in one place you can reference later. All our chats will happen in a thread in this channel.
...
3. Join Discord: If you have not already, you will need to join the KCD Community on Discord by creating an account on kentcdodds.com and clicking "connect discord" on your profile page. Join the discord thread above by introducing yourself.
...
   
On Jun 16, 2025 at 11:53:58 AM, Joshua Miles <[EMAIL]> wrote:
...
The login link above is valid for 24 hours or until it is used once. You will stay logged in for 60 days. Click here to request another link if the link above isn't working.
...
```text
I'll switch you over to the 15th :)
```
...
We booked and paid for the Epic React Pro Individuals workshop yesterday through your website for $599 and have not received an email confirming our booking yet ( see attached screenshot after booking ).

Could you please check and inform us about this.
...
[https://www.facebook.com/aoepeople]<https://www.facebook.com/aoepeople>

[https://twitter.com/aoepeople]<https://twitter.com/aoepeople>

[https://www.linkedin.com/company/aoe]<https://www.linkedin.com/company/aoe>

[https://www.xing.com/company/aoe]<https://www.xing.com/company/aoe>

[https://www.instagram.com/aoepeople]<https://www.instagram.com/aoepeople>

[https://www.youtube.com/user/aoepeople]<https://www.youtube.com/user/aoepeople>
...
I am signed up for tomorrow's (7/30) Advanced MCP workshop but I do not see
a google calendar invite. Would you please resend it?
...
I purchased around 1 hour ago your workshop, but so far, didn't receive it
any email confirmation.
The e-mail used for purchase was [EMAIL], it's an alias from this
email.
...
www.yld.io
Twitter <https://twitter.com/YLDio> / LinkedIn
<https://www.linkedin.com/company/yld/> / Github <https://github.com/yldio/>


<http://www.yld.io/>
*YLD is a limited company registered in England and Wales. Registered
number: [PHONE]. Registered office: YLD, 20 Old Bailey, London, EC4M 7AN.*
```

**Answer**

```text
There is no password login. Visit the site, button in the top right, enter the email address, receive email at email address.
```
...
Thanks for the student discount. I just purchased and super excited to attend. Will there be a zoom link sent out as well?
...
There are a few things you need to know in advance so we can make the most of the time we have together for the Advanced React with TypeScript workshop on Friday, June 16th at 9AM Pacific.


We use Zoom, so be sure to have it installed.


We will get started right away, so having the workshop repository installed and set up ahead of time is required. No time will be available for troubleshooting setup issues when the workshop begins.
...
Be sure to pull changes over the next couple of days leading up to the workshop, as there may be some updates! It may also be helpful to work through the React with TypeScript tutorial ahead of time: https://www.totaltypescript.com/tutorials/react-with-typescript
...
Join Zoom Meeting
https://egghead.zoom.us/j/[PHONE]?pwd=eUZQVUdLMWF4UHJTZ3Vlc3ZYKzRrdz09


Meeting ID: [PHONE] 8065
Passcode: 045686
```
...
The first workshop was excellent! So far I have only received calendar invites for the first two classes. When will the remaining calendar invites be sent out?
...
```text
You'll get them soon! I'm just working through a few things on the repos still :) I don't want people to set it up before I finish the last tweaks.
```
...
Can you please resend me the invite to the video call? Either I didn't recieve it or I deleted it by mistake.
